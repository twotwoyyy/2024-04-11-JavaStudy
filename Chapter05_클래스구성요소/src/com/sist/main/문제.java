...
----------------------------------------------
3) 하나의 클래스로 하나의 객체만 생성할 수 있다. => new를 이용하면 여러개의 객체 생성이 가능 
----------------------------------------------
4) 객체는 클래스의 인스턴스이다.
...
-------------------------------------------
  1. 클래스의 종류 
     = 데이터형 클래스 : 사용자 정의 데이터형 => 관련된 데이터를 한번에 모아서 전송 => 웹 
        => 변수만 설정  
        class Student
        {
            String name;
...
------------------------------------
   ...
   --------- 다른 클래스와 연결 => public 
   {
       ...
       => 결과값 전송 
       return 값; 
              --- 결과값이 없는 경우 => 리턴형 :void , return; return생약이 가능 
   }
...
2) 인스턴스 필드는 생성자 및 정적 블록에서 초기화될 수 있다.
   static과 관련된 메소드 ,초기화 => static변수, static메소드만 가능 
------------------------------------------------
...
public class 문제 {
  ...
  public static void main(String[] args)  throws Exception{
	  ...
	  a.display(1,2,3,4,5);
	  a.display(1,2);
	  a.display(1,2,3,4,5,65,6,7,7,7,7,7,7,7,7,7,7);
  }
}